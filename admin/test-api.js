...
async function runTests() {
  ...
  await testAPI('/admin/login', 'POST', { username: 'admin', password: 'admin123' });
  ...
  await testAPI('/admin/products', 'POST', { name: 'Test Product', price: 100 });
  ...
  await testAPI('/admin/orders/ORD-001/status', 'PUT', { status: 'shipped', trackingNumber: 'TRK123' });
