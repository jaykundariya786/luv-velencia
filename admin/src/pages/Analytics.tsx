...
import { getDocuments, queryDocuments } from '../lib/firebase';
...
interface AnalyticsData {
  revenue: {
    ...
    previous: number;
    change: number;
    data: Array<{ period: string; revenue: number; orders: number; customers: number }>;
  };
  orders: {
    total: number;
    pending: number;
  ...
  products: {
    topSelling: Array<{ name: string; sales: number; revenue: number; image: string }>;
    categories: Array<{ name: string; sales: number; percentage: number; color: string }>;
    inventory: Array<{ category: string; inStock: number; lowStock: number; outOfStock: number }>;
  };
  traffic: {
    sessions: number;
    pageViews: number;
    ...
    data: Array<{ period: string; sessions: number; pageViews: number; conversions: number }>;
  };
    ...
    try {
      ...
      const mockAnalytics: AnalyticsData = {
        revenue: {
          ...
          change: 17.9,
          data: [
            { period: 'Jun 4', revenue: 4200, orders: 28, customers: 24 },
            { period: 'Jun 5', revenue: 5800, orders: 35, customers: 31 },
            { period: 'Jun 6', revenue: 6200, orders: 42, customers: 38 },
        ...
        products: {
          topSelling: [
            {
              ...
              sales: 45,
              revenue: 13499.55,
              image: 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=60&h=60&fit=crop'
            },
            {
              name: 'Designer Leather Handbag',
              sales: 32,
              revenue: 6079.68,
              image: 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=60&h=60&fit=crop'
            },
            {
            ...
            },
            {
              ...
              sales: 28,
              revenue: 4479.72,
              image: 'https://images.unsplash.com/photo-1544966503-7cc5ac882d5b?w=60&h=60&fit=crop'
            }
          ],
          categories: [
            { name: 'Dresses', sales: 125, percentage: 32, color: '#8B5CF6' },
            { name: 'Accessories', sales: 98, percentage: 25, color: '#3B82F6' },
          ...
          inventory: [
            ...
            { category: 'Accessories', inStock: 67, lowStock: 12, outOfStock: 4 },
        ...
        traffic: {
          ...
          data: [
            { period: 'Jun 4', sessions: 1180, pageViews: 3420, conversions: 28 },
            { period: 'Jun 5', sessions: 1340, pageViews: 3890, conversions: 35 },
            { period: 'Jun 6', sessions: 1520, pageViews: 4320, conversions: 42 },
            { period: 'Jun 7', sessions: 1280, pageViews: 3650, conversions: 38 },
            { period: 'Jun 8', sessions: 1450, pageViews: 4180, conversions: 48 },
            { period: 'Jun 9', sessions: 1580, pageViews: 4560, conversions: 52 },
            { period: 'Jun 10', sessions: 1640, pageViews: 4660, conversions: 55 }
          ]
        },
        geography: [
  ...
  if (error || !analytics) {
    return (
      <div className="flex flex-col items-center justify-center h-64">
        <p className="text-red-600 text-lg font-medium mb-4">{error || 'No data available'}</p>
        <button 
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
          <div>
            ...
            <p className="text-gray-600 mt-1">Track performance and insights for your business</p>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-2xl font-bold text-gray-900 mt-2">{formatCurrency(analytics.revenue.current)}</p>
              <div className={`flex items-center mt-2 text-sm ${revenueChange.color}`}>
          ...
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <div className="flex items-center mt-2 text-sm">
                <span className="text-green-600 font-medium">{analytics.orders.completed}</span>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-2xl font-bold text-gray-900 mt-2">{analytics.customers.total}</p>
              <div className="flex items-center mt-2 text-sm">
                <span className="text-green-600 font-medium">{analytics.customers.new}</span>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-2xl font-bold text-gray-900 mt-2">{formatCurrency(analytics.orders.avgOrderValue)}</p>
              <div className="flex items-center mt-2 text-sm">
                <span className="text-green-600 font-medium">{analytics.customers.retention}%</span>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-gray-500">Product category performance</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-gray-500">Visitor engagement metrics</p>
            </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              ...
              <span className="font-semibold text-gray-900">{analytics.traffic.sessions.toLocaleString()}</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div className="flex items-center space-x-3">
              ...
              <span className="font-semibold text-gray-900">{analytics.traffic.pageViews.toLocaleString()}</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div className="flex items-center space-x-3">
              ...
              <span className="font-semibold text-gray-900">{analytics.traffic.bounceRate}%</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div className="flex items-center space-x-3">
              ...
              <span className="font-semibold text-gray-900">{analytics.traffic.avgSessionDuration}</span>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-3">
            {analytics.geography.map((country, index) => (
              <div key={index} className="flex items-center justify-between">
                ...
                <span className="ml-3 text-sm font-semibold text-gray-900">{country.sales}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500">Stock levels across categories</p>
          </div>
