...
import { getDocuments, queryDocuments, getOrderedDocuments } from '../lib/firebase';
...
const Dashboard: React.FC = () => {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      // Create mock data for demonstration since Firebase collections might be empty
      const mockData: DashboardData = {
        ...
        topProducts: [
          ...
          },
          {
            ...
            sales: 38,
            revenue: 7599.62,
            image: 'https://images.unsplash.com/photo-1434389677669-e08b4cac3105?w=100&h=100&fit=crop&crop=center'
          },
          {
            name: 'Pearl Necklace',
            sales: 22,
        ...
        ordersByStatus: [
          ...
          { name: 'Shipped', value: 67, color: '#3B82F6' },
          { name: 'Pending', value: 30, color: '#EF4444' }
        ],
        salesByCategory: [
          { category: 'Dresses', sales: 45, revenue: 22500 },
          { category: 'Accessories', sales: 38, revenue: 19000 },
          { category: 'Outerwear', sales: 32, revenue: 16000 },
          { category: 'Jewelry', sales: 28, revenue: 14000 },
          { category: 'Shoes', sales: 25, revenue: 12500 }
        ]
      };
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen space-y-4">
        <div className="text-red-600 text-lg font-medium text-center px-4">{error}</div>
        <button 
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <div className={`mt-2 flex items-center space-x-1 text-xs sm:text-sm ${changeData.color}`}>
